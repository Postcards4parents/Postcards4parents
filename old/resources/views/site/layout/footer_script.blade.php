...
if($('#form3')[0].checkValidity()) {
  ...
  $('#form3').parsley();
  //document.getElementById("fname").setCustomValidity("Lorum Ipsum");
      ...
      $('#login').on('click',function(e){
       ...
       // loader_toast();
        ...
        success:function(data){
          ...
          {
            toastr.error("Email and password do not match");
          }
          else{
 ...
 $('#loginDetail').on('click',function(e){
      ...
      // loader_toast();
       ...
       success:function(data){
         ...
         {
           toastr.error("Email Id Password does not match.");
         }
         else{
           $.each(data.errors, function(key, value){
             toastr.error(value);
