...
<div id="draggable" class="ui-widget-content dragabox">
  <div id="dg1" class="dgBox">
    ...
    <figure><img src="{!! asset('site') !!}/images/shape.png" class="img-fluid"></figure>
          ...
          <div class="row">
            <aside class="col-md-4 col-lg-4">
              ...
              <div class="receive">
                You’ll receive:
                <ul>
                  <li>*FREE access to age-specific tools</li>
                  <li>*Weekly info and tips targeted at your child’s developmental stage and issues</li>
                </ul>
              </div>
            </aside>
