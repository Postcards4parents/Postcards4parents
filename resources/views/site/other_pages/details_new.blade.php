...
//         ->where("sys.publishedCounter[gte]","1");
//         $entries_values = $client->getEntries($Newquery1);
...
//         ->where("sys.publishedCounter[gte]","1");
//         $entries_values_idea = $client->getEntries($Newquery2);
...
//           $atThisAgeRender=$renderer->render($atThisAge);
...
//               $ideaDescription=$videa->get('idea');
//               $ideaDescriptionVal=$renderer->render($ideaDescription);
//               $total_ideas[]=[
//                   'title'=>$ideaTitle,
//                   'ideaDesc'=>$ideaDescriptionVal
