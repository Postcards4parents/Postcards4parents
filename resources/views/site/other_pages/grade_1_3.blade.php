...
<section class="topBanner">
 ...
 @php
        ...
        if(!empty($_COOKIE['grades']))
        {
          ...
          $grades="$grade_ID_1,$grade_ID_2,$grade_ID_3";
         

        }else{
          $grade_ID_1="51hefRXWCDPDCrEGXCehNL";
          $grade_ID_3="7hFAY0Adk5rbJ3wwlmnoig";
          $grade_ID_2="1UiJGtb7k4I7NpoljnfzXx";
          $grades="$grade_ID_1,$grade_ID_2,$grade_ID_3";
        }
  ...
  ->where("fields.gradeLevel.sys.id[in]",$grades)
  ...
  $query=$query->setContentType("postcard")
     ...
     ->setLimit($limit)
     //->where("sys.publishedAt[exists]",true)
     //->where("sys.publishedCounter[exists]",true);
     ->where("sys.publishedCounter[gte]","1");
...
@endif 
   ...
   <center> No Postcards related to this category grade</center>
           ...
           @else
           <div class="col-md-12 col-sm-12">
            No Postcards found related to this category grade
           </div>
           @endif
          </div>		
          </div>   
