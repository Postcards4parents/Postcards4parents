      ...
      <div class="box box-primary">
        ...
        <form role="form" id="form">
          <div class="box-body">
            ...
            <input type="text" value="{{$cat->name}}" required class="form-control" id="categoryName" placeholder="category name">
    ...
    $("#submitCat").click(function(e){
          ...
          $.ajax({
              ...
              if(data.status==true)
              {
                  ...
                  toastr.success('Category updated', 'category Updated successfully');
                  var date = new Date();
                  var timestamp = Math.round(date.getTime()/1000);
                  window.location.href="{{ url('category') }}?new="+timestamp;
