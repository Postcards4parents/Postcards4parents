        ...
        <tr>
          <td>
            <div style="margin:0px; padding:25px 0;">
              ...
              <p style="margin:0px; padding:0px; font-size:18px; color:#1c75bc; line-height:24px;">{{ $entrys->emailText->getContent()[1]->getContent()[0]->getValue() }}</p>
            </div>
          </td>
        </tr>
      <tr>
        ...
        <tr>
          <td style="text-align:center;">
            <a style="text-align:center; margin:0px; padding:0px; border:0px;" href="{{url('/')}}"><img src="{{asset('site/images/gotokit.jpg')}}"></a>
          </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        ...
        <tr>
          <td>
            ...
            <ul style="margin:0px; padding:0px 0px 0px 25px;">
              @foreach($entrys->emailText->getContent()[3]->getContent() as $bottom)
