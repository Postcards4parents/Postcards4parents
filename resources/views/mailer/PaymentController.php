    ...
    public function store(Request $request)
    {
        ...
        $id = DB::table('offer_payemnt_tbl')->insertGetId($insertedData);
				...
				try
				{
					...
					Mail::send('mailer.newsub', ["entrys" => $entrys, 'fname' => $names[0]], function ($message) use ($emailSubjectLine)
					{

						$message->to("raman@sourcesoftsolutions.com")->subject($emailSubjectLine);
					});
