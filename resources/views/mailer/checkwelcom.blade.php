  ...
  <tr>
    <td align="center" valign="middle">
        ...
        <tr>
          <td>
            <div style="margin:0px; padding:25px 0;">
              ...
              <p style="margin:0px; padding:0px; font-size:18px; color:#1c75bc; line-height:24px;">{{ $entrys->emailText->getContent()[1]->getContent()[0]->getValue() }} {{ $entrys->emailText->getContent()[1]->getContent()[1]->getValue() }}</p>
            </div>
          </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
      ...
      <tr>
        ...
        <tr>
          <td>
            <p style="margin:0px; padding:0px; color:#1c75bc;">{{ $entrys->bottomText->getContent()[3]->getContent()[0]->getValue() }}</p>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <p style="margin:0px; padding:0px; color:#1c75bc; font-style:italic;">{{ $entrys->bottomText->getContent()[4]->getContent()[0]->getValue() }}</p>
          </td>
        </tr>
