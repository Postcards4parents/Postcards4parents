        ...
        <tr>
          <td>
            <div style="margin:0px; padding:25px 0;">
              ...
              <p style="margin:0px; padding:0px; font-size:18px; color:#1c75bc; line-height:24px;">{{ $entrys->emailText->getContent()[0]->getContent()[0]->getValue() }} {{ $entrys->emailText->getContent()[1]->getContent()[0]->getValue() }}</p>
            </div>
          </td>
        </tr>
      <tr>
        ...
        <tr>
          <td style="text-align:center;">
            <a style="text-align:center; margin:0px; padding:0px; border:0px;" href="{{url('/')}}"><img src="{{asset('site/images/getpostcards.jpg')}}"></a>
          </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
        ...
        <tr>
          <td>
            <p style="margin:0px; padding:0px; color:#1c75bc; font-style:italic;">{{ $entrys->bottomText->getContent()[1]->getContent()[0]->getValue() }}</p>
            <p style="margin:0px; padding:0px; color:#1c75bc; font-style:italic;">{{ $entrys->bottomText->getContent()[2]->getContent()[0]->getValue() }}</p>
          </td>
        </tr>
